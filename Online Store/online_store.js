...
var products_div = document.querySelector('.product');
...
{
    // We want to go to next page
    console.log('product', product);

    // 1. Here we are storing the data of clicked product in localStorage in the form of json file.
    // 2. And using it later to move to another page.
    // 3. JSON.stringify converts the code to json format.
    // 4. Whenever we have to do such thing when we have to move to another page when particular thing is clicked, store in kson and move further.
